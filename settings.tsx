...
export const mintText = [
  ...
  { label: "default", mintText: "Live", buttonLabel: "Mint now!", header: "Public Mint"}
];

//header image in the ui. replace with your own
export const image = "https://media.publit.io/file/nft-p.jpg";

//website title
export const headerText = "Froklotto";